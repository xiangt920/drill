...
public class CorrelationFunctions {
  ...
  /*
    Compute a correlation matrix for a table with optional target columns specified.
   ...
   */
  @FunctionTemplate(name = "correlation", scope = FunctionTemplate.FunctionScope.POINT_AGGREGATE)
  public static class Correlation3 implements DrillAggFunc {
  ...
  @FunctionTemplate(name = "correlation", scope = FunctionTemplate.FunctionScope.POINT_AGGREGATE)
  public static class Correlation2 implements DrillAggFunc {
  ...
  @FunctionTemplate(name = "correlation", scope = FunctionTemplate.FunctionScope.SIMPLE)
  public static class CorrelationMessage implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      String help = org.apache.drill.madlib.correlation.Correlation.help(msg, false);
  ...
  @FunctionTemplate(name = "correlation", scope = FunctionTemplate.FunctionScope.SIMPLE)
  public static class CorrelationEmpty implements DrillSimpleFunc {
    ...
    @Override
    public void eval() {
      String help = org.apache.drill.madlib.correlation.Correlation.help("", false);
      org.apache.drill.madlib.common.DataHolderUtils.resetVarcharOut(buf, out, help);
      buf = out.buffer;
    }
  }
