 ...
 */
      ...
      public:
        ...
        std::function<Datum()> getMToDatumFn();
      ...
      protected:
        ...
        Datum getAsDatum(jobject inFCInfo,
      ...
      AnyType Null();
      int32 extractDoubleArray(AnyType array, double* &result);
      int32 extractDoubleArrayH(AnyType array, double* &result);
      int32* extract2DDoubleArray(AnyType array, double** &result);
      int32* extract2DDoubleArrayH(AnyType array, double** &result);
